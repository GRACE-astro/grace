/**
 * @file thunder/utils/lifetime_tracker.hh
...
#ifndef THUNDER_UTILS_LIFETIME_TRACKER_HH
#define THUNDER_UTILS_LIFETIME_TRACKER_HH
...
/**
 * @brief Lifetimes of thunder singleton objects
 * \ingroup system
 * 
