/**
 * @file thunder/memory/new_delete_allocator.hh
 * @author Carlo Musolino (musolino@itp.uni-frankfurt.de)
 * @brief Bring <code> std::malloc </code> and <code> std::free </code> into thunder's allocator system
 * @version 0.1
 * @date 2023-03-10
 * 
 ...
 * 
 */
#ifndef THUNDER_NEW_DELETE_ALLOCATOR_HH
#define THUNDER_NEW_DELETE_ALLOCATOR_HH
