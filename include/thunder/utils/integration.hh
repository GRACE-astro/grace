 ...
 * 
 */
#ifndef THUNDER_UTILS_INTEGRATION_HH 
#define THUNDER_UTILS_INTEGRATION_HH

#include <thunder/utils/inline.h>
#include <thunder/utils/device.h> 
#include <thunder/utils/constexpr.hh> 
#include <thunder/utils/affine_transformation.hh>
...
struct integrator_t {
   ...
   */
  static THUNDER_ALWAYS_INLINE T 
...
template< typename F >
static double THUNDER_ALWAYS_INLINE 
