 ...
 * @brief this header contains the definition of thunder's configuration file parser.
 * @version 0.1
 * @date 2023-03-13
 * 
...
#ifndef THUNDER_SYSTEM_CONFIG_PARSER_HH
#define THUNDER_SYSTEM_CONFIG_PARSER_HH
