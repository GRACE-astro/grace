#ifndef GRACE_PHYSICS_ID_FMTORUS_HM1_HH
#define GRACE_PHYSICS_ID_FMTORUS_HM1_HH


/**
* @brief Return the enthalpy minus 1 in Kerr-Schild cartesian coordinates at location x,y,z
* 
...
get_hm1(double const xcoord, double const ycoord, double const zcoord,
...
#endif /* GRACE_PHYSICS_ID_FMTORUS_HM1_HH */
