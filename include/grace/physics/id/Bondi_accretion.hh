...
//**************************************************************************************************
/**
 * @brief Boondi accretion MHD test - spherical accretion to test MHD
*
...
struct bondi_accretion_id_t {
    ...
    bondi_accretion_id_t(
        ...
        double bmag_ = 0.0, double beta_sonic_ = 0.0)
        : pcoords(pcoords_), M(M_), mdot(mdot_), r_sonic(r_sonic_),
...
private:
    ...
    {
        // Implementation of Newton-Raphson solver for Bondi equations
        // Similar to the original Einstein Toolkit implementation
        // TODO!
    }
