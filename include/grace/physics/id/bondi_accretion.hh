...
struct bondi_accretion_id_t {
    ...
    bondi_accretion_id_t(
        ...
        // Output solution to file for checking
        /*
        std::ofstream fout("bondi.asc");
        fout << std::setprecision(14) << std::scientific;
        for (int i = 0; i < N_points; ++i) {
            fout << std::setw(5) << i << " "
                 << std::setw(22) << r_bondi[i] << " "
                 << std::setw(22) << rschwarz[i] << " "
                 << std::setw(22) << rho_bondi[i] << " "
                 << std::setw(22) << u_bondi[i] << " "
                 << std::setw(22) << v_bondi[i] << "\n";
        }
        fout.close();
        */      
    }
