 ...
 * @brief Factories that assemble prolongation task descriptors (including the Tóth-Roe divergence-preserving variant for face-staggered B) for each ghost-zone element kind.
 * @date 2025-09-05
 * 
