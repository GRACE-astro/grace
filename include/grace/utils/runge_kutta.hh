...
static GRACE_HOST_DEVICE constexpr const double c[4]    = { 0., 0.5, 0.5, 1. } ; 
static GRACE_HOST_DEVICE constexpr const double b[4]    = {1./6., 1./3., 1./3., 1./6.} ; 
static GRACE_HOST_DEVICE constexpr const double a[4][4] = {
    { 0., 0., 0., 0. },
    { 0.5, 0., 0., 0. },
    { 0., 0.5, 0., 0. },
    { 0., 0.,  0., 1. }
...
static GRACE_HOST_DEVICE constexpr const double c[6]  = { 0., 0.25, 3./8., 12./13., 1., 0.5 } ; 
static GRACE_HOST_DEVICE constexpr const double b5[6] = {16./135., 0., 6656./12825., 28561./56430, -9./50., 2./55.} ; 
static GRACE_HOST_DEVICE constexpr const double b4[6] = {25./216., 0., 1408./2565., 2197./4104., -0.2, 0} ; 
static GRACE_HOST_DEVICE constexpr const double a[6][6] = {
    { 0., 0., 0., 0., 0., 0. },
    { 0.25, 0., 0., 0., 0., 0. },
    { 3./32., 9./32., 0., 0., 0., 0. },
