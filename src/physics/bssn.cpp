                ...
                , double const k1, double const eta )
{
    ...
    res[ATXXL+0] = Atxxdx*betaX + 2*Atxx*betaXdx + Atxxdy*betaY + 2*Atxy*betaYdx + Atxxdz*betaZ + 2*Atxz*betaZdx - (2*Atxx*(betaXdx + betaYdy + betaZdz))/3. - alp*(2*(Atxx*Atxx)*gtXX + 4*Atxx*Atxy*gtXY + 4*Atxx*Atxz*gtXZ + 2*(Atxy*Atxy)*gtYY + 4*Atxy*Atxz*gtYZ + 2*(Atxz*Atxz)*gtZZ - Atxx*K) + (exp(-4.*phi)*(-3*DiDjalpxx + DDalp*gtxx + alp*(3*RTFxx - 24*pi*Sxx + 8*gtxx*pi*S*exp(4.*phi))))/3.;
    ...
    res[ATXXL+3] = Atyydx*betaX + 2*Atxy*betaXdy + Atyydy*betaY + 2*Atyy*betaYdy + Atyydz*betaZ + 2*Atyz*betaZdy - (2*Atyy*(betaXdx + betaYdy + betaZdz))/3. + alp*(-2*(Atxy*Atxy*gtXX + 2*Atxy*(Atyy*gtXY + Atyz*gtXZ) + Atyy*Atyy*gtYY + 2*Atyy*Atyz*gtYZ + Atyz*Atyz*gtZZ) + Atyy*K) + (exp(-4.*phi)*(-3*DiDjalpyy + DDalp*gtyy + alp*(3*RTFyy - 24*pi*Syy + 8*gtyy*pi*S*exp(4.*phi))))/3.;
    ...
    res[ATXXL+5] = Atzzdx*betaX + 2*Atxz*betaXdz + Atzzdy*betaY + 2*Atyz*betaYdz + Atzzdz*betaZ + 2*Atzz*betaZdz - (2*Atzz*(betaXdx + betaYdy + betaZdz))/3. + alp*(-2*(Atxz*Atxz*gtXX + 2*Atxz*(Atyz*gtXY + Atzz*gtXZ) + Atyz*Atyz*gtYY + 2*Atyz*Atzz*gtYZ + Atzz*Atzz*gtZZ) + Atzz*K) + (exp(-4.*phi)*(-3*DiDjalpzz + DDalp*gtzz + alp*(3*RTFzz - 24*pi*Szz + 8*gtzz*pi*S*exp(4.*phi))))/3.;
